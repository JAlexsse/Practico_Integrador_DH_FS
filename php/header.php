<header>
  ...
  <div class="header-nav-top">
    <div class="nav-contacto float-left">
      <ul class="nav">
        <li class="nav-item">
          <a class="nav-link active" href="tel:543516999999" target="_blank"> <img src="img/ICONOS/telefono.svg" alt=""
              height="16"> +54 3516 999 999</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="mailto:info@bicisnoe.com.ar" target="_blank"> <img src="img/ICONOS/mail.svg" alt=""
              height="16"> info@bicisnoe.com.ar</a>
        </li>
      </ul>
    </div>
  ...
  <nav class="navbar navbar-expand-md navbar-dark col-12" style="background-color:rgb(30,30,30)">
    <div class="row mx-0 w-100 justify-content-around">
      ...
      <a class="col navbar-brand text-center" href="index.php"><img src="img/ICONOS/LOGO/logo_blanco.svg" alt="logo"
          height="35"></a> <!-- Logo -->
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        ...
        <form class="form d-flex my-2  d-md-none" action="tienda.php" method="GET">
          <input class="form-control ml-2" type="search" placeholder="Search" aria-label="Search" name="buscar">
          <button class="btn" type="submit"><img src="img/ICONOS/UTILIDAD AMARILLOS/busqueda.svg" alt=""
              height="18"></button>
